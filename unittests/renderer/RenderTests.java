...
public class RenderTests {
   ...
   /** Test for XML/JSON based scene - for bonus */
   @Test
   public void basicRenderJson() {
      try {
         // Load the scene data from the json file into the scene object
         SceneLoader.loadSceneFromJson(scene, "./images/test.json");
